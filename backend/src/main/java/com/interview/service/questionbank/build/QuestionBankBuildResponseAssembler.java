...
public class QuestionBankBuildResponseAssembler {
    ...
    public QuestionBankBuildResponse toResponse(QuestionBankBuild build, Long jobId) {
        ...
        response.setFileCount(files.size()); response.setChunkCount(build.getChunkCount()); response.setEstimatedCallCount(build.getChunkCount() == null ? 0 : build.getChunkCount() * 2);
        ...
        response.setErrorMessage(build.getErrorMessage()); response.setCreateTime(build.getCreateTime()); response.setUpdateTime(build.getUpdateTime());
        return response;
    }
