...
- For private position imports, keep the source `id` stable in the package; the application adds a knowledge-base namespace during import to avoid cross-user collisions.
